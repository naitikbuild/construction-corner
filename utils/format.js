// Formats a rupee amount using compact K/Cr notation, e.g. 85000 -> "₹85K", 12000000 -> "₹1.2Cr".
export function formatAmountK(amount) {
  ...
  if (n < 1000) return `₹${n}`;
  if (n < 1_00_00_000) return `₹${trim(n / 1000)}K`;
