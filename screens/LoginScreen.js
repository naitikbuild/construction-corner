...
const styles = StyleSheet.create({
  ...
  splashLogoBox: { width: 96, height: 96, borderRadius: 28, backgroundColor: '#FFF3E0', alignItems: 'center', justifyContent: 'center', marginBottom: 24, borderWidth: 2, borderColor: '#FF6B2B' },
  splashLogoEmoji: { fontSize: 48 },
  splashTitle: { fontSize: 28, fontWeight: '900', color: '#1A1A1A', marginBottom: 8, textAlign: 'center' },
  splashTagline: { fontSize: 14, color: '#666666', fontWeight: '600', marginBottom: 48, textAlign: 'center' },
  splashVersion: { fontSize: 11, color: '#ccc', fontWeight: '600', marginTop: 24 },

  onboard: { flex: 1, backgroundColor: '#F5F5F0', padding: 24, alignItems: 'center' },
  ...
  onboardTitle: { fontSize: 28, fontWeight: '800', color: '#1A1A1A', textAlign: 'center', lineHeight: 36, marginBottom: 14 },
  onboardSub: { fontSize: 14, color: '#666666', textAlign: 'center', lineHeight: 22, marginBottom: 32, paddingHorizontal: 8 },
  ...
  tabRow: { flexDirection: 'row', marginHorizontal: 24, marginBottom: 20, backgroundColor: '#EFEFEF', borderRadius: 12, padding: 4 },
  ...
  countryCode: { backgroundColor: '#FFFFFF', borderRadius: 12, paddingHorizontal: 14, justifyContent: 'center', borderWidth: 1.5, borderColor: '#EFEFEF' },
  countryCodeText: { fontSize: 14, fontWeight: '700', color: '#1A1A1A' },
  phoneInput: { flex: 1, backgroundColor: '#FFFFFF', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, fontSize: 16, fontWeight: '700', borderWidth: 1.5, borderColor: '#EFEFEF', color: '#1A1A1A' },
  textInput: { backgroundColor: '#FFFFFF', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, fontSize: 15, fontWeight: '600', borderWidth: 1.5, borderColor: '#EFEFEF', color: '#1A1A1A' },
  otpHint: { fontSize: 12, color: '#666666', marginBottom: 10 },
  otpInput: { backgroundColor: '#FFFFFF', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, fontSize: 26, fontWeight: '900', borderWidth: 2, borderColor: '#FF6B2B', color: '#1A1A1A', letterSpacing: 10 },
  resendText: { fontSize: 12, color: '#FF6B2B', fontWeight: '700', marginTop: 8, textAlign: 'right' },
  ...
  emailBtnOutline: { borderWidth: 2, borderColor: '#1A1A2E', backgroundColor: '#fff' },
  emailBtnFill: { backgroundColor: '#FF6B2B' },
  emailBtnOutlineText: { fontSize: 16, fontWeight: '700', color: '#1A1A2E' },
